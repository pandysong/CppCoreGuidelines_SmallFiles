...
All C++ programmers. This includes [programmers who might consider C](01_main.md#S-cpl).
...
These guidelines are designed according to the "subset of superset" principle ([Stroustrup05](01_main.md#Stroustrup05)).
They do not simply define a subset of C++ to be used (for reliability, safety, performance, or whatever).
Instead, they strongly recommend the use of a few simple "extensions" ([library components](01_main.md#S-gsl))
...
The rules are designed to allow [gradual adoption](01_main.md#S-modernizing).
...
If you need a tutorial for some given level of experience, see [the references](01_main.md#S-references).
...
However, see [the modernization section](01_main.md#S-modernizing) for some possible approaches to modernizing/rejuvenating/upgrading.
...
where "tag" is the anchor name of the item where the Enforcement rule appears (e.g., for [C.134](06_C_Classes_and_class_hierarchies.md#Rh-public) it is "Rh-public"), the
name of a profile group-of-rules ("type", "bounds", or "lifetime"),
or a specific rule in a profile ([type.4](21_Pro_Profiles.md#Pro-type-cstylecast), or [bounds.2](#Pro-bounds-arrayindex)).
...
Such information is found in the **Alternative** paragraphs and the [Discussion](01_main.md#S-discussion) sections.
...
Recommended information sources can be found in [the references](01_main.md#S-references).
