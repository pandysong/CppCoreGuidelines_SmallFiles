...
Any programmer using these guidelines should know the [guidelines support library](01_main.md#S-gsl), and use it appropriately.
...
Avoid dependence on undefined behavior (e.g., [undefined order of evaluation](09_ES_Expressions_and_statements.md#Res-order))
...
For more details about for-statements, see [ES.71](09_ES_Expressions_and_statements.md#Res-for-range).
...
* [The guidelines support library](01_main.md#S-gsl)
* [The ISO C++ Standard Library](01_main.md#S-stdlib)
...
Prefer [RAII](08_R_Resource_management.md#Rr-raii):
...
**See also**: [The resource management section](01_main.md#S-resource)
...
Enforcing [the lifetime safety profile](21_Pro_Profiles.md#SS-lifetime) eliminates leaks.
When combined with resource safety provided by [RAII](08_R_Resource_management.md#Rr-raii), it eliminates the need for "garbage collection" (by generating no garbage).
Combine this with enforcement of [the type and bounds profiles](02_In_Introduction.md#SS-force) and you get complete type- and resource-safety, guaranteed by tools.

##### Enforcement

* Look at pointers: Classify them into non-owners (the default) and owners.
  Where feasible, replace owners with standard-library resource handles (as in the example above).
  Alternatively, mark an owner as such using `owner` from [the GSL](01_main.md#S-gsl).
...
See [Con: Constants and immutability](01_main.md#S-const)
...
This is a variant of the [subset of superset principle](02_In_Introduction.md#R0) that underlies these guidelines.
...
* [Concurrency tools](11_CP_Concurrency_and_parallelism.md#Rconc-tools)
* [Testing tools](???)
