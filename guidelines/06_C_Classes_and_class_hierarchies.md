...
* [define a class with private data as `class`](06_C_Classes_and_class_hierarchies.md#Rc-class)
* [Prefer to place the interface first in a class](23_NL_Naming_and_layout_rules.md#Rl-order)
* [minimize exposure of members](06_C_Classes_and_class_hierarchies.md#Rc-private)
* [Avoid `protected` data](06_C_Classes_and_class_hierarchies.md#Rh-protected)
...
This is especially important for [overloaded operators](06_C_Classes_and_class_hierarchies.md#Ro-namespace).
...
Prefer to place the interface first in a class, [see NL.16](23_NL_Naming_and_layout_rules.md#Rl-order).
...
[`protected` data is a bad idea](06_C_Classes_and_class_hierarchies.md#Rh-protected).

##### Note

Prefer the order `public` members before `protected` members before `private` members [see](23_NL_Naming_and_layout_rules.md#Rl-order).

##### Enforcement

* [Flag protected data](06_C_Classes_and_class_hierarchies.md#Rh-protected).
...
* [C.10: Prefer concrete types over class hierarchies](06_C_Classes_and_class_hierarchies.md#Rc-concrete)
* [C.11: Make concrete types regular](06_C_Classes_and_class_hierarchies.md#Rc-regular)
...
* [C.20: If you can avoid defining any default operations, do](06_C_Classes_and_class_hierarchies.md#Rc-zero)
* [C.21: If you define or `=delete` any default operation, define or `=delete` them all](06_C_Classes_and_class_hierarchies.md#Rc-five)
* [C.22: Make default operations consistent](06_C_Classes_and_class_hierarchies.md#Rc-matched)

Destructor rules:

* [C.30: Define a destructor if a class needs an explicit action at object destruction](06_C_Classes_and_class_hierarchies.md#Rc-dtor)
* [C.31: All resources acquired by a class must be released by the class's destructor](06_C_Classes_and_class_hierarchies.md#Rc-dtor-release)
* [C.32: If a class has a raw pointer (`T*`) or reference (`T&`), consider whether it might be owning](06_C_Classes_and_class_hierarchies.md#Rc-dtor-ptr)
* [C.33: If a class has an owning pointer member, define or `=delete` a destructor](06_C_Classes_and_class_hierarchies.md#Rc-dtor-ptr2)
* [C.35: A base class with a virtual function needs a virtual destructor](06_C_Classes_and_class_hierarchies.md#Rc-dtor-virtual)
* [C.36: A destructor may not fail](06_C_Classes_and_class_hierarchies.md#Rc-dtor-fail)
* [C.37: Make destructors `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-dtor-noexcept)

Constructor rules:

* [C.40: Define a constructor if a class has an invariant](06_C_Classes_and_class_hierarchies.md#Rc-ctor)
* [C.41: A constructor should create a fully initialized object](06_C_Classes_and_class_hierarchies.md#Rc-complete)
* [C.42: If a constructor cannot construct a valid object, throw an exception](06_C_Classes_and_class_hierarchies.md#Rc-throw)
* [C.43: Ensure that a copyable (value type) class has a default constructor](06_C_Classes_and_class_hierarchies.md#Rc-default0)
* [C.44: Prefer default constructors to be simple and non-throwing](06_C_Classes_and_class_hierarchies.md#Rc-default00)
* [C.45: Don't define a default constructor that only initializes data members; use member initializers instead](06_C_Classes_and_class_hierarchies.md#Rc-default)
* [C.46: By default, declare single-argument constructors `explicit`](06_C_Classes_and_class_hierarchies.md#Rc-explicit)
* [C.47: Define and initialize member variables in the order of member declaration](06_C_Classes_and_class_hierarchies.md#Rc-order)
* [C.48: Prefer in-class initializers to member initializers in constructors for constant initializers](06_C_Classes_and_class_hierarchies.md#Rc-in-class-initializer)
* [C.49: Prefer initialization to assignment in constructors](06_C_Classes_and_class_hierarchies.md#Rc-initialize)
* [C.50: Use a factory function if you need "virtual behavior" during initialization](06_C_Classes_and_class_hierarchies.md#Rc-factory)
* [C.51: Use delegating constructors to represent common actions for all constructors of a class](06_C_Classes_and_class_hierarchies.md#Rc-delegating)
* [C.52: Use inheriting constructors to import constructors into a derived class that does not need further explicit initialization](06_C_Classes_and_class_hierarchies.md#Rc-inheriting)

Copy and move rules:

* [C.60: Make copy assignment non-`virtual`, take the parameter by `const&`, and return by non-`const&`](06_C_Classes_and_class_hierarchies.md#Rc-copy-assignment)
* [C.61: A copy operation should copy](06_C_Classes_and_class_hierarchies.md#Rc-copy-semantic)
* [C.62: Make copy assignment safe for self-assignment](06_C_Classes_and_class_hierarchies.md#Rc-copy-self)
* [C.63: Make move assignment non-`virtual`, take the parameter by `&&`, and return by non-`const&`](06_C_Classes_and_class_hierarchies.md#Rc-move-assignment)
* [C.64: A move operation should move and leave its source in a valid state](06_C_Classes_and_class_hierarchies.md#Rc-move-semantic)
* [C.65: Make move assignment safe for self-assignment](06_C_Classes_and_class_hierarchies.md#Rc-move-self)
* [C.66: Make move operations `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-move-noexcept)
* [C.67: A polymorphic class should suppress copying](06_C_Classes_and_class_hierarchies.md#Rc-copy-virtual)

Other default operations rules:

* [C.80: Use `=default` if you have to be explicit about using the default semantics](06_C_Classes_and_class_hierarchies.md#Rc-eqdefault)
* [C.81: Use `=delete` when you want to disable default behavior (without wanting an alternative)](06_C_Classes_and_class_hierarchies.md#Rc-delete)
* [C.82: Don't call virtual functions in constructors and destructors](06_C_Classes_and_class_hierarchies.md#Rc-ctor-virtual)
* [C.83: For value-like types, consider providing a `noexcept` swap function](06_C_Classes_and_class_hierarchies.md#Rc-swap)
* [C.84: A `swap` may not fail](06_C_Classes_and_class_hierarchies.md#Rc-swap-fail)
* [C.85: Make `swap` `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-swap-noexcept)
* [C.86: Make `==` symmetric with respect of operand types and `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-eq)
* [C.87: Beware of `==` on base classes](06_C_Classes_and_class_hierarchies.md#Rc-eq-base)
* [C.89: Make a `hash` `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-hash)
...
Alternatively to prevent slicing as per [C.67](06_C_Classes_and_class_hierarchies.md#Rc-copy-virtual),
...
For most classes the answer is "no" either because the class holds no resources or because destruction is handled by [the rule of zero](06_C_Classes_and_class_hierarchies.md#Rc-zero);
that is, its members can take care of themselves as concerns destruction.
If the answer is "yes", much of the design of the class follows (see [the rule of five](06_C_Classes_and_class_hierarchies.md#Rc-five)).
...
What about a sockets that won't close? A destructor, close, or cleanup operation [should never fail](06_C_Classes_and_class_hierarchies.md#Rc-dtor-fail).
...
See [discussion](25_Appendix_C_Discussion.md#Sd-never-fail).
...
[A `T*` should not do so](08_R_Resource_management.md#Rr-ptr), but in older code, that's common.
...
Note that if you define a destructor, you must define or delete [all default operations](06_C_Classes_and_class_hierarchies.md#Rc-five):
...
See [this in the Discussion section](25_Appendix_C_Discussion.md#Sd-dtor).
...
See [discussion](25_Appendix_C_Discussion.md#Sd-dtor).
To make the problem worse, many "close/release" operations are not retryable.
If at all possible, consider failure to close/cleanup a fundamental design error and terminate.
...
##### Reason
 ...
 [A destructor may not fail](06_C_Classes_and_class_hierarchies.md#Rc-dtor-fail). If a destructor tries to exit with an exception, it's a bad design error and the program had better terminate.
...
Also, the default for `int` would be better done as a [member initializer](06_C_Classes_and_class_hierarchies.md#Rc-in-class-initializer).

**See also**: [construct valid object](06_C_Classes_and_class_hierarchies.md#Rc-complete) and [constructor throws](06_C_Classes_and_class_hierarchies.md#Rc-throw).
...
If a valid object cannot conveniently be constructed by a constructor, [use a factory function](06_C_Classes_and_class_hierarchies.md#Rc-factory).
...
If a constructor acquires a resource (to create a valid object), that resource should be [released by the destructor](06_C_Classes_and_class_hierarchies.md#Rc-dtor-release).
The idiom of having constructors acquire resources and destructors release them is called [RAII](08_R_Resource_management.md#Rr-raii) ("Resource Acquisition Is Initialization").
...
There the `is_valid()` technique must be used. In such cases, check `is_valid()` consistently and immediately to simulate [RAII](08_R_Resource_management.md#Rr-raii).

##### Alternative

If you feel tempted to use some "post-constructor initialization" or "two-stage initialization" idiom, try not to do that.
If you really have to, look at [factory functions](06_C_Classes_and_class_hierarchies.md#Rc-factory).
...
[Delegating constructors](06_C_Classes_and_class_hierarchies.md#Rc-delegating) and [default member initialization](06_C_Classes_and_class_hierarchies.md#Rc-in-class-initializer) do that better.
Another reason has been to delay initialization until an object is needed; the solution to that is often [not to declare a variable until it can be properly initialized](09_ES_Expressions_and_statements.md#Res-init)
...
A [value type](06_C_Classes_and_class_hierarchies.md#SS-concrete) is a class that is copyable (and usually also comparable).
...
However, most realistic `Date` classes have a "first date" (e.g. January 1, 1970 is popular), so making that the default is usually trivial.
    ...
    public:
        Date(int dd, int mm, int yyyy);
        Date() = default; // [See also](06_C_Classes_and_class_hierarchies.md#Rc-default)
        // ...
    private:
        int dd = 1;
        int mm = 1;
...
**See also**: [Discussion of implicit conversions](06_C_Classes_and_class_hierarchies.md#Ro-conversion)
...
**See also**: [Discussion](25_Appendix_C_Discussion.md#Sd-order)
...
**See also**: [Discussion](25_Appendix_C_Discussion.md#Sd-factory)
...
**See also**: If the "repeated action" is a simple initialization, consider [an in-class member initializer](06_C_Classes_and_class_hierarchies.md#Rc-in-class-initializer).
...
It is simple and efficient. If you want to optimize for rvalues, provide an overload that takes a `&&` (see [F.18](05_F_Functions.md#Rf-consume)).
...
The `swap` implementation technique offers the [strong guarantee](01_main.md#Abrahams01).
...
By writing directly to the target elements, we will get only [the basic guarantee](01_main.md#Abrahams01) rather than the strong guarantee offered by the `swap` technique. Beware of [self-assignment](06_C_Classes_and_class_hierarchies.md#Rc-copy-self).
...
See [copy constructor vs. `clone()`](06_C_Classes_and_class_hierarchies.md#Rc-copy-virtual).
...
You can handle self-assignment by explicitly testing for self-assignment, but often it is faster and more elegant to cope without such a test (e.g., [using `swap`](06_C_Classes_and_class_hierarchies.md#Rc-swap)).
...
**See**: [The rule for copy-assignment](06_C_Classes_and_class_hierarchies.md#Rc-copy-assignment).

##### Enforcement

Equivalent to what is done for [copy-assignment](06_C_Classes_and_class_hierarchies.md#Rc-copy-assignment).
...
The one-in-a-million argument against `if (this == &a) return *this;` tests from the discussion of [self-assignment](06_C_Classes_and_class_hierarchies.md#Rc-copy-self) is even more relevant for self-move.
...
If you need to create deep copies of polymorphic objects, use `clone()` functions: see [C.130](06_C_Classes_and_class_hierarchies.md#Rh-copy).
...
**See also** [factory functions](06_C_Classes_and_class_hierarchies.md#Rc-factory) for how to achieve the effect of a call to a derived class function without risking undefined behavior.
...
##### Reason
 ...
 [A `swap` may not fail](06_C_Classes_and_class_hierarchies.md#Rc-swap-fail).
...
**See also**: [Resources](01_main.md#S-resource)
...
Function objects should be cheap to copy (and therefore [passed by value](05_F_Functions.md#Rf-in)).
...
* [C.120: Use class hierarchies to represent concepts with inherent hierarchical structure (only)](06_C_Classes_and_class_hierarchies.md#Rh-domain)
* [C.121: If a base class is used as an interface, make it a pure abstract class](06_C_Classes_and_class_hierarchies.md#Rh-abstract)
* [C.122: Use abstract classes as interfaces when complete separation of interface and implementation is needed](06_C_Classes_and_class_hierarchies.md#Rh-separation)

Designing rules for classes in a hierarchy summary:

* [C.126: An abstract class typically doesn't need a constructor](06_C_Classes_and_class_hierarchies.md#Rh-abstract-ctor)
* [C.127: A class with a virtual function should have a virtual or protected destructor](06_C_Classes_and_class_hierarchies.md#Rh-dtor)
* [C.128: Virtual functions should specify exactly one of `virtual`, `override`, or `final`](06_C_Classes_and_class_hierarchies.md#Rh-override)
* [C.129: When designing a class hierarchy, distinguish between implementation inheritance and interface inheritance](06_C_Classes_and_class_hierarchies.md#Rh-kind)
* [C.130: For making deep copies of polymorphic classes prefer a virtual `clone` function instead of copy construction/assignment](06_C_Classes_and_class_hierarchies.md#Rh-copy)
* [C.131: Avoid trivial getters and setters](06_C_Classes_and_class_hierarchies.md#Rh-get)
* [C.132: Don't make a function `virtual` without reason](06_C_Classes_and_class_hierarchies.md#Rh-virtual)
* [C.133: Avoid `protected` data](06_C_Classes_and_class_hierarchies.md#Rh-protected)
* [C.134: Ensure all non-`const` data members have the same access level](06_C_Classes_and_class_hierarchies.md#Rh-public)
* [C.135: Use multiple inheritance to represent multiple distinct interfaces](06_C_Classes_and_class_hierarchies.md#Rh-mi-interface)
* [C.136: Use multiple inheritance to represent the union of implementation attributes](06_C_Classes_and_class_hierarchies.md#Rh-mi-implementation)
* [C.137: Use `virtual` bases to avoid overly general base classes](06_C_Classes_and_class_hierarchies.md#Rh-vbase)
* [C.138: Create an overload set for a derived class and its bases with `using`](06_C_Classes_and_class_hierarchies.md#Rh-using)
* [C.139: Use `final` sparingly](06_C_Classes_and_class_hierarchies.md#Rh-final)
* [C.140: Do not provide different default arguments for a virtual function and an overrider](06_C_Classes_and_class_hierarchies.md#Rh-virtual-default-arg)

Accessing objects in a hierarchy rule summary:

* [C.145: Access polymorphic objects through pointers and references](06_C_Classes_and_class_hierarchies.md#Rh-poly)
* [C.146: Use `dynamic_cast` where class hierarchy navigation is unavoidable](06_C_Classes_and_class_hierarchies.md#Rh-dynamic_cast)
* [C.147: Use `dynamic_cast` to a reference type when failure to find the required class is considered an error](06_C_Classes_and_class_hierarchies.md#Rh-ref-cast)
* [C.148: Use `dynamic_cast` to a pointer type when failure to find the required class is considered a valid alternative](06_C_Classes_and_class_hierarchies.md#Rh-ptr-cast)
* [C.149: Use `unique_ptr` or `shared_ptr` to avoid forgetting to `delete` objects created using `new`](06_C_Classes_and_class_hierarchies.md#Rh-smart)
* [C.150: Use `make_unique()` to construct objects owned by `unique_ptr`s](06_C_Classes_and_class_hierarchies.md#Rh-make_unique)
* [C.151: Use `make_shared()` to construct objects owned by `shared_ptr`s](06_C_Classes_and_class_hierarchies.md#Rh-make_shared)
* [C.152: Never assign a pointer to an array of derived class objects to a pointer to its base](06_C_Classes_and_class_hierarchies.md#Rh-array)
* [C.153: Prefer virtual function to casting](06_C_Classes_and_class_hierarchies.md#Rh-use-virtual)
...
A pure interface class is simply a set of pure virtual functions; see [I.25](04_I_Interfaces.md#Ri-abstract).
...
Another (related) technique for separating interface and implementation is [Pimpl](04_I_Interfaces.md#Ri-pimpl).
...
Generally, it is recommended to use smart pointers to represent ownership (see [R.20](08_R_Resource_management.md#Rr-owner)). However, because of language rules, the covariant return type cannot be a smart pointer: `D::clone` can't return a `unique_ptr<D>` while `B::clone` returns `unique_ptr<B>`. Therefore, you either need to consistently return `unique_ptr<B>` in all overrides, or use `owner<>` utility from the [Guidelines Support Library](22_GSL_Guidelines_support_library.md#SS-views).
...
Note that we can put default initializers on member variables: [C.49: Prefer initialization to assignment in constructors](06_C_Classes_and_class_hierarchies.md#Rc-initialize).
...
[Prefer `private` data](06_C_Classes_and_class_hierarchies.md#Rc-private) with a well-specified and enforced invariant.
Alternative, and often better, [keep data out of any class used as an interface](06_C_Classes_and_class_hierarchies.md#Rh-abstract).
...
* *All public*: If you're writing an aggregate bundle-of-variables without an invariant across those variables, then all the variables should be `public`.
  [By convention, declare such classes `struct` rather than `class`](06_C_Classes_and_class_hierarchies.md#Rc-struct)
...
`Interface` is the root of an [interface hierarchy](06_C_Classes_and_class_hierarchies.md#Rh-abstract)
and `Utility` is the root of an [implementation hierarchy](06_C_Classes_and_class_hierarchies.md#Rh-kind).
...
[Prefer virtual functions to casting](06_C_Classes_and_class_hierarchies.md#Rh-use-virtual).
...
* This rule is part of the [type-safety profile](21_Pro_Profiles.md#Pro-type-downcast).
...
Contrast with [C.147](06_C_Classes_and_class_hierarchies.md#Rh-ptr-cast), where failure is an error, and should not be used for conditional execution.
...
See [C.146](06_C_Classes_and_class_hierarchies.md#Rh-dynamic_cast) and ???
...
* [C.160: Define operators primarily to mimic conventional usage](06_C_Classes_and_class_hierarchies.md#Ro-conventional)
* [C.161: Use nonmember functions for symmetric operators](06_C_Classes_and_class_hierarchies.md#Ro-symmetric)
* [C.162: Overload operations that are roughly equivalent](06_C_Classes_and_class_hierarchies.md#Ro-equivalent)
* [C.163: Overload only for operations that are roughly equivalent](06_C_Classes_and_class_hierarchies.md#Ro-equivalent-2)
* [C.164: Avoid conversion operators](06_C_Classes_and_class_hierarchies.md#Ro-conversion)
* [C.165: Use `using` for customization points](06_C_Classes_and_class_hierarchies.md#Ro-custom)
* [C.166: Overload unary `&` only as part of a system of smart pointers and references](06_C_Classes_and_class_hierarchies.md#Ro-address-of)
* [C.167: Use an operator for an operation with its conventional meaning](06_C_Classes_and_class_hierarchies.md#Ro-overload)
* [C.168: Define overloaded operators in the namespace of their operands](06_C_Classes_and_class_hierarchies.md#Ro-namespace)
* [C.170: If you feel like overloading a lambda, use a generic lambda](06_C_Classes_and_class_hierarchies.md#Ro-lambda)
...
Here, the conventional semantics is maintained: [Copies compare equal](06_C_Classes_and_class_hierarchies.md#SS-copy).
...
Nonmember operators should be either friends or defined in [the same namespace as their operands](06_C_Classes_and_class_hierarchies.md#Ro-namespace).
[Binary operators should treat their operands equivalently](06_C_Classes_and_class_hierarchies.md#Ro-symmetric).
...
This is a special case of the rule that [helper functions should be defined in the same namespace as their class](06_C_Classes_and_class_hierarchies.md#Rc-helper).
...
* [C.180: Use `union`s to save Memory](06_C_Classes_and_class_hierarchies.md#Ru-union)
* [C.181: Avoid "naked" `union`s](06_C_Classes_and_class_hierarchies.md#Ru-naked)
* [C.182: Use anonymous `union`s to implement tagged unions](06_C_Classes_and_class_hierarchies.md#Ru-anonymous)
* [C.183: Don't use a `union` for type punning](06_C_Classes_and_class_hierarchies.md#Ru-pun)
* ???
...
But heed the warning: [Avoid "naked" `union`s](06_C_Classes_and_class_hierarchies.md#Ru-naked)
