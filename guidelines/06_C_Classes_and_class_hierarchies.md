...
* [C.67: A base class should suppress copying, and provide a virtual `clone` instead if "copying" is desired](06_C_Classes_and_class_hierarchies.md#Rc-copy-virtual)
...
If you need covariant return types, return an `owner<derived*>`. See [C.130](06_C_Classes_and_class_hierarchies.md#Rh-copy).
...
* [C.130: Redefine or prohibit copying for a base class; prefer a virtual `clone` function instead](06_C_Classes_and_class_hierarchies.md#Rh-copy)
...
Note that because of language rules, the covariant return type cannot be a smart pointer. See also [C.67](06_C_Classes_and_class_hierarchies.md#Rc-copy-virtual).
