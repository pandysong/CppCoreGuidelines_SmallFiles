...
With C++11 plus [concepts](14_T_Templates_and_generic_programming.md#SS-concepts), we can do better still
...
Premature optimization is said to be [the root of all evil](10_Per_Performance.md#Rper-Knuth), but that's not a reason to despise performance.
...
* Information passing:
Prefer clean [interfaces](01_main.md#S-interfaces) carrying sufficient information for later improvement of implementation.
Note that information flows into and out of an implementation through the interfaces we provide.
* Compact data: By default, [use compact data](10_Per_Performance.md#Rper-compact), such as `std::vector` and [access it in a systematic fashion](10_Per_Performance.md#Rper-access).
...
Use [conventional ways](05_F_Functions.md#Rf-conventional) of passing information through an interface;
...
The [standard library](01_main.md#S-stdlib) is a good first place to look for inspiration.
* Isolation:
...
A need for efficiency does not imply a need for [low-level code](10_Per_Performance.md#Rper-low).
...
This rule does not contradict the [Don't optimize prematurely](10_Per_Performance.md#Rper-Knuth) rule.
