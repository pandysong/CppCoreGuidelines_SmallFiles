...
See also [CP.mess: Message Passing](11_CP_Concurrency_and_parallelism.md#SScp-mess) and [CP.31: prefer pass by value](11_CP_Concurrency_and_parallelism.md#Rconc-data-by-value).
...
[(rare) proper uses of `volatile`](11_CP_Concurrency_and_parallelism.md#Rconc-volatile2)
...
* For parallel algorithms, see [parallelism](11_CP_Concurrency_and_parallelism.md#SScp-par)
* For inter-task communication without explicit sharing, see [messaging](11_CP_Concurrency_and_parallelism.md#SScp-mess)
* For vector parallel code, see [vectorization](11_CP_Concurrency_and_parallelism.md#SScp-vec)
* For lock-free programming, see [lock free](11_CP_Concurrency_and_parallelism.md#SScp-free)

Concurrency rule summary:

* [CP.20: Use RAII, never plain `lock()`/`unlock()`](11_CP_Concurrency_and_parallelism.md#Rconc-raii)
* [CP.21: Use `std::lock()` or `std::scoped_lock` to acquire multiple `mutex`es](11_CP_Concurrency_and_parallelism.md#Rconc-lock)
* [CP.22: Never call unknown code while holding a lock (e.g., a callback)](11_CP_Concurrency_and_parallelism.md#Rconc-unknown)
* [CP.23: Think of a joining `thread` as a scoped container](11_CP_Concurrency_and_parallelism.md#Rconc-join)
* [CP.24: Think of a `thread` as a global container](11_CP_Concurrency_and_parallelism.md#Rconc-detach)
* [CP.25: Prefer `gsl::joining_thread` over `std::thread`](11_CP_Concurrency_and_parallelism.md#Rconc-joining_thread)
* [CP.26: Don't `detach()` a thread](11_CP_Concurrency_and_parallelism.md#Rconc-detached_thread)
* [CP.31: Pass small amounts of data between threads by value, rather than by reference or pointer](11_CP_Concurrency_and_parallelism.md#Rconc-data-by-value)
* [CP.32: To share ownership between unrelated `thread`s use `shared_ptr`](11_CP_Concurrency_and_parallelism.md#Rconc-shared)
* [CP.40: Minimize context switching](11_CP_Concurrency_and_parallelism.md#Rconc-switch)
* [CP.41: Minimize thread creation and destruction](11_CP_Concurrency_and_parallelism.md#Rconc-create)
* [CP.42: Don't `wait` without a condition](11_CP_Concurrency_and_parallelism.md#Rconc-wait)
* [CP.43: Minimize time spent in a critical section](11_CP_Concurrency_and_parallelism.md#Rconc-time)
* [CP.44: Remember to name your `lock_guard`s and `unique_lock`s](11_CP_Concurrency_and_parallelism.md#Rconc-name)
* [CP.50: Define a `mutex` together with the data it guards. Use `synchronized_value<T>` where possible](11_CP_Concurrency_and_parallelism.md#Rconc-mutex)
...
This rule is redundant if you [don't `detach()`](11_CP_Concurrency_and_parallelism.md#Rconc-detached_thread) and [use `gsl::joining_thread`](11_CP_Concurrency_and_parallelism.md#Rconc-joining_thread).
...
[don't `detach`](11_CP_Concurrency_and_parallelism.md#Rconc-detached_thread).
...
* Suggest ["exporting ownership"](11_CP_Concurrency_and_parallelism.md#Rconc-detached_thread) to an enclosing scope if it detaches.
...
But that compromises safety and violates the [use RAII](11_CP_Concurrency_and_parallelism.md#Rconc-raii) rule.
...
* [CP.60: Use a `future` to return a value from a concurrent task](11_CP_Concurrency_and_parallelism.md#Rconc-future)
* [CP.61: Use a `async()` to spawn a concurrent task](11_CP_Concurrency_and_parallelism.md#Rconc-async)
* message queues
* messaging libraries
...
* [CP.100: Don't use lock-free programming unless you absolutely have to](11_CP_Concurrency_and_parallelism.md#Rconc-lockfree)
* [CP.101: Distrust your hardware/compiler combination](11_CP_Concurrency_and_parallelism.md#Rconc-distrust)
* [CP.102: Carefully study the literature](11_CP_Concurrency_and_parallelism.md#Rconc-literature)
* how/when to use atomics
* avoid starvation
* use a lock-free data structure rather than hand-crafting specific lock-free access
* [CP.110: Do not write your own double-checked locking for initialization](11_CP_Concurrency_and_parallelism.md#Rconc-double)
* [CP.111: Use a conventional pattern if you really need double-checked locking](11_CP_Concurrency_and_parallelism.md#Rconc-double-pattern)
...
Double-checked locking is easy to mess up. If you really need to write your own double-checked locking, in spite of the rules [CP.110: Do not write your own double-checked locking for initialization](11_CP_Concurrency_and_parallelism.md#Rconc-double) and [CP.100: Don't use lock-free programming unless you absolutely have to](11_CP_Concurrency_and_parallelism.md#Rconc-lockfree), then do it in a conventional pattern.

The uses of the double-checked locking pattern that are not in violation of [CP.110: Do not write your own double-checked locking for initialization](11_CP_Concurrency_and_parallelism.md#Rconc-double) arise when a non-thread-safe action is both hard and rare, and there exists a fast thread-safe test that can be used to guarantee that the action is not needed, but cannot be used to guarantee the converse.

##### Example, bad

The use of volatile does not make the first check thread-safe, see also [CP.200: Use `volatile` only to talk to non-C++ memory](11_CP_Concurrency_and_parallelism.md#Rconc-volatile2)
...
* [CP.200: Use `volatile` only to talk to non-C++ memory](11_CP_Concurrency_and_parallelism.md#Rconc-volatile2)
* [CP.201: ??? Signals](11_CP_Concurrency_and_parallelism.md#Rconc-signal)
...
In C++, unlike in some other languages, `volatile` has [nothing to do with synchronization](11_CP_Concurrency_and_parallelism.md#Rconc-volatile).
