...
* A constructor that cannot construct an object (failure to establish its class's [invariant](06_C_Classes_and_class_hierarchies.md#Rc-struct))
...
**See also**: [RAII](12_E_Error_handling.md#Re-raii)

**See also**: [discussion](25_Appendix_C_Discussion.md#Sd-noexcept)

##### Note

Before deciding that you cannot afford or don't like exception-based error handling, have a look at the [alternatives](12_E_Error_handling.md#Re-no-throw-raii);
...
An [invariant](06_C_Classes_and_class_hierarchies.md#Rc-struct) is logical condition for the members of an object that a constructor must establish for the public member functions to assume.
...
**See also**: [If a constructor cannot construct a valid object, throw an exception](06_C_Classes_and_class_hierarchies.md#Rc-throw)
...
as a last resort, cleanup actions can be represented by a [`final_action`](12_E_Error_handling.md#Re-finally) object.
...
**See also**: [precondition rule](04_I_Interfaces.md#Ri-pre)
...
**See also**: [postcondition rule](04_I_Interfaces.md#Ri-post)
...
Do not use traditional [exception-specifications](12_E_Error_handling.md#Re-specifications).

##### See also

[discussion](25_Appendix_C_Discussion.md#Sd-noexcept).
...
Sometimes, [`finally()`](12_E_Error_handling.md#Re-finally) can make such unsystematic cleanup a bit more manageable.
...
Most handlers do not modify their exception and in general we [recommend use of `const`](09_ES_Expressions_and_statements.md#Res-const).
...
Also, [make move operations `noexcept`](06_C_Classes_and_class_hierarchies.md#Rc-move-noexcept).
...
**See also**: [discussion](25_Appendix_C_Discussion.md#Sd-never-fail)
...
Let cleanup actions on the unwinding path be handled by [RAII](12_E_Error_handling.md#Re-raii).
...
* proper resource handles and [RAII](12_E_Error_handling.md#Re-raii)
* [`finally`](12_E_Error_handling.md#Re-finally)
...
Prefer [proper resource management objects](12_E_Error_handling.md#Re-raii).
Consider `finally` a last resort.

##### Note

Use of `finally` is a systematic and reasonably clean alternative to the old [`goto exit;` technique](12_E_Error_handling.md#Re-no-throw-codes)
...
Even without exceptions, [RAII](12_E_Error_handling.md#Re-raii) is usually the best and most systematic way of dealing with resources.
...
So, the primary guideline for error handling is "use exceptions and [RAII](12_E_Error_handling.md#Re-raii)."
...
Before condemning exceptions or complaining too much about their cost, consider examples of the use of [error codes](12_E_Error_handling.md#Re-no-throw-codes).
...
**See also**: [Simulating RAII](12_E_Error_handling.md#Re-no-throw-raii)
...
This approach fits with [simulated RAII resource management](12_E_Error_handling.md#Re-no-throw-raii).
...
`finally` can [ease the pain a bit](12_E_Error_handling.md#Re-finally).
...
We [prefer exception-based error handling](12_E_Error_handling.md#Re-throw) and recommend [keeping functions short](05_F_Functions.md#Rf-single).

**See also**: [Discussion](#Sd-???)

**See also**: [Returning multiple values](05_F_Functions.md#Rf-out-multi)
...
For example, see [Stroustrup94](01_main.md#Stroustrup94).

##### Note

If no exception may be thrown, use [`noexcept`](12_E_Error_handling.md#Re-noexcept) or its equivalent `throw()`.
