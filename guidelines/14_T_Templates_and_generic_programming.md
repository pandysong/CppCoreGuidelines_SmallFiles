...
See [Stable base](14_T_Templates_and_generic_programming.md#Rt-abi).
...
Examples include type erasure as with `std::shared_ptr`'s deleter (but [don't overuse type erasure](14_T_Templates_and_generic_programming.md#Rt-erasure)).
...
* [T.12: Prefer concept names over `auto`](14_T_Templates_and_generic_programming.md#Rt-auto)
...
* [T.25: Avoid complimentary constraints](14_T_Templates_and_generic_programming.md#Rt-not)
...
This is a specific variant of the general rule that [a concept must make semantic sense](14_T_Templates_and_generic_programming.md#Rt-low).
...
See the [Palo Alto TR](01_main.md#S-references) for examples.
...
To disambiguate them, see [T.24](14_T_Templates_and_generic_programming.md#Rt-tag).
...
**See also**: [T.69](14_T_Templates_and_generic_programming.md#Rt-customization)
...
For N == 1, we have a choice of a base class of a class in the surrounding scope as in [T.61](14_T_Templates_and_generic_programming.md#Rt-scary).
...
see ["stable base"](14_T_Templates_and_generic_programming.md#Rt-abi) and [OO and GP](14_T_Templates_and_generic_programming.md#Rt-generic-oo)
...
Note that `maul()` violates the a [`T*` points to an individual object rule](05_F_Functions.md#Rf-ptr).
...
Note that the assignment in `maul2()` violated the [no-slicing rule](09_ES_Expressions_and_statements.md#Res-slice).
...
**Alternative**: Use a [Pimpl](04_I_Interfaces.md#Ri-pimpl) implementation.
...
Instead, use concepts. But see [How to emulate concepts if you don't have language support](14_T_Templates_and_generic_programming.md#Rt-emulate).

##### Example

    ??? good

**Alternative**: If the result is a value, rather than a type, use a [`constexpr` function](14_T_Templates_and_generic_programming.md#Rt-fct).
