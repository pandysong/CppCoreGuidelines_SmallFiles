...
* [SL.con.1: Prefer using STL `array` or `vector` instead of a C array](17_SL_The_Standard_Library.md#Rsl-arrays)
* [SL.con.2: Prefer using STL `vector` by default unless you have a reason to use a different container](17_SL_The_Standard_Library.md#Rsl-vector)
* [SL.con.3: Avoid bounds errors](17_SL_The_Standard_Library.md#Rsl-bounds)
*  ???
...
This rule is part of the [bounds profile](21_Pro_Profiles.md#SS-bounds).
...
**See also**: [regular expressions](17_SL_The_Standard_Library.md#SS-regex)
...
* [SL.str.1: Use `std::string` to own character sequences](17_SL_The_Standard_Library.md#Rstr-string)
* [SL.str.2: Use `std::string_view` or `gsl::string_span` to refer to character sequences](17_SL_The_Standard_Library.md#Rstr-view)
* [SL.str.3: Use `zstring` or `czstring` to refer to a C-style, zero-terminated, sequence of characters](17_SL_The_Standard_Library.md#Rstr-zstring)
* [SL.str.4: Use `char*` to refer to a single character](17_SL_The_Standard_Library.md#Rstr-char*)
* [SL.str.5: Use `std::byte` to refer to byte values that do not necessarily represent characters](17_SL_The_Standard_Library.md#Rstr-byte)

* [SL.str.10: Use `std::string` when you need to perform locale-sensitive string operations](17_SL_The_Standard_Library.md#Rstr-locale)
* [SL.str.11: Use `gsl::string_span` rather than `std::string_view` when you need to mutate a string](17_SL_The_Standard_Library.md#Rstr-span)
* [SL.str.12: Use the `s` suffix for string literals meant to be standard-library `string`s](17_SL_The_Standard_Library.md#Rstr-s)

**See also**:

* [F.24 span](05_F_Functions.md#Rf-range)
* [F.25 zstring](05_F_Functions.md#Rf-zstring)
...
[Don't optimize prematurely](10_Per_Performance.md#Rper-Knuth)
...
See [`zstring`](17_SL_The_Standard_Library.md#Rstr-zstring), [`string`](17_SL_The_Standard_Library.md#Rstr-string), and [`string_span`](17_SL_The_Standard_Library.md#Rstr-view).
...
`std::string` supports standard-library [`locale` facilities](17_SL_The_Standard_Library.md#Rstr-locale)
...
* [SL.io.1: Use character-level input only when you have to](17_SL_The_Standard_Library.md#Rio-low)
* [SL.io.2: When reading, always consider ill-formed input](17_SL_The_Standard_Library.md#Rio-validate)
* [SL.io.3: Prefer iostreams for I/O](17_SL_The_Standard_Library.md#Rio-streams)
* [SL.io.10: Unless you use `printf`-family functions call `ios_base::sync_with_stdio(false)`](17_SL_The_Standard_Library.md#Rio-sync)
* [SL.io.50: Avoid `endl`](17_SL_The_Standard_Library.md#Rio-endl)
* [???](#???)
...
* [S.C.1: Don't use setjmp/longjmp](17_SL_The_Standard_Library.md#Rclib-jmp)
* [???](#???)
* [???](#???)
