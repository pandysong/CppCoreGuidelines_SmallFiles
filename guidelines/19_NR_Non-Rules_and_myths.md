...
* [Always initialize an object](09_ES_Expressions_and_statements.md#Res-always)
...
Also, this style is a temptation to use the [goto exit](19_NR_Non-Rules_and_myths.md#Rnr-goto-exit) non-rule.
...
* [RAII](12_E_Error_handling.md#Re-raii)
...
* Use exceptions and [RAII](12_E_Error_handling.md#Re-raii)
* for non-RAII resources, use [`finally`](12_E_Error_handling.md#Re-finally).
...
* [Make member data `public` or (preferably) `private`](06_C_Classes_and_class_hierarchies.md#Rh-protected)
